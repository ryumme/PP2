...
# sounds
gameOverSound = pygame.mixer.Sound('lab9/music/crash.wav')
pygame.mixer.music.load('lab9/music/car.wav')
laugh = pygame.mixer.Sound('lab9/music/laugh.wav')

# images
playerImage = pygame.image.load('lab9/image/car1.png')
car3 = pygame.image.load('lab9/image/car3.png')
car4 = pygame.image.load('lab9/image/car4.png')
coin = pygame.image.load('lab9/image/coin.jpg')
playerRect = playerImage.get_rect()
baddieImage = pygame.image.load('lab9/image/car2.png')
sample = [car3, car4, baddieImage]
wallLeft = pygame.image.load('lab9/image/left.png')
wallRight = pygame.image.load('lab9/image/right.png')
...
zero = 0
if not os.path.exists("lab9/data/save.dat") :
    f = open("lab9/data/save.dat", 'w')
    f.write(str(zero))
    f.close()
v = open("lab9/data/save.dat", 'r')
